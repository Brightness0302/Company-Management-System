                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="email" class="form-control" id="_adduserusername" placeholder="Username">
                                <label for="floatingEmail">User Name</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="password" class="form-control" id="_adduserpassword"
                        ...
                        <div class="row mt-3 ">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" multiple aria-label="multiple select example"
                                    ...
                                    <option value="<?=$company['id']-1?>"><?=str_replace("_"," ",$company['name'])?>
                                    </option>
                                    <?php endforeach;?>
                                </select>
                            </div>
