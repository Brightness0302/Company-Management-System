                        ...
                        <table class="table table-bordered table-hover text-center text-xxs">
                            ...
                            <?php foreach ($lines as $index => $line):?>
                                <tr>
                                    ...
                                    <td><label class='m-auto inline-block'><?=number_format($line['acquisition_unit_price_on_invoice'], 4, '.', "")?></label> <div class='inline-block main_coin'><?=$product['invoice_coin']?></div></td>
                                    <td><label class='m-auto inline-block'><?=number_format($line['acquisition_unit_price'], 4, '.', "")?></label> <div class='inline-block main_coin'><?=$product['main_coin']?></div></td>
                                    <td><label class='m-auto inline-block'><?=number_format($line['acquisition_vat_value'], 4, '.', "")?></label> <div class='inline-block main_coin'><?=$product['main_coin']?></div></td>
                                    <td><label class='m-auto inline-block'><?=number_format($line['acquisition_unit_price_with_vat'], 4, '.', "")?></label> <div class='inline-block main_coin'><?=$product['main_coin']?></div></td>
                                    <td><label class='m-auto inline-block'><?=number_format($line['amount_without_vat'], 4, '.', "")?></label> <div class='inline-block main_coin'><?=$product['main_coin']?></div></td>
                                    <td><label class='m-auto inline-block'><?=number_format($line['amount_vat_value'], 4, '.', "")?></label> <div class='inline-block main_coin'><?=$product['main_coin']?></div></td>
                                    <td><label class='m-auto inline-block'><?=number_format($line['total_amount'], 4, '.', "")?></label> <div class='inline-block main_coin'><?=$product['main_coin']?></div></td>
                                    <td><label class='m-auto inline-block'><?=number_format($line['selling_unit_price_without_vat'], 4, '.', "")?></label> <div class='inline-block main_coin'><?=$product['main_coin']?></div></td>
                                    <td><label class='m-auto inline-block'><?=number_format($line['selling_unit_vat_value'], 4, '.', "")?></label> <div class='inline-block main_coin'><?=$product['main_coin']?></div></td>
                                    <td><label class='m-auto inline-block'><?=number_format($line['selling_unit_price_with_vat'], 4, '.', "")?></label> <div class='inline-block main_coin'><?=$product['main_coin']?></div></td>
                                    <td><label class='m-auto inline-block'><?=number_format($line['selling_unit_price_without_vat']*$line['quantity_on_document'], 4, '.', "")?></label> <div class='inline-block main_coin'><?=$product['main_coin']?></div class='inline-block main_coin'></td>
                                    <td><label class='m-auto inline-block'><?=number_format($line['selling_unit_vat_value']*$line['quantity_on_document'], 4, '.', "")?></label> <div class='inline-block main_coin'><?=$product['main_coin']?></div class='inline-block main_coin'></td>
                                    <td><label class='m-auto inline-block'><?=number_format($line['selling_unit_price_with_vat']*$line['quantity_on_document'], 4, '.', "")?></label> <div class='inline-block main_coin'><?=$product['main_coin']?></div class='inline-block main_coin'></td>
