                        ...
                        <div class="col-sm-3 text-center d-flex">
                            <table class="table " style="border : 1px solid gray; text-align: left">
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-auto">
                                            <input type="text" class="form-control " id="production_description" value="<?=$product['production_description']?>" title="Choose your color">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="col-sm-3 text-center">
                            <table class="table " style="border : 1px solid gray; text-align: left">
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-auto">
                                            <input type="text" class="form-control " id="unit" value="<?=$product['unit']?>" title="Choose your color">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-auto">
                                            <input type="number" class="form-control " id="acquisition_unit_price" value="<?=$product['acquisition_unit_price']?>" title="Choose your color">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-auto">
                                            <input type="number" min="0" max="100" class="form-control " id="vat_percent" value="<?=$product['vat_percent']?>" title="Choose your color">
                                        </div>  
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="col-sm-3 text-center">
                            <table class="table " style="border : 1px solid gray; text-align: left">
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-auto">
                                            <input type="text" class="form-control " id="quantity_of_document" value="<?=$product['quantity_of_document']?>" title="Choose your color">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-auto">
                                            <input type="text" class="form-control " id="quantity_received" value="<?=$product['quantity_received']?>" title="Choose your color">
                                        </div>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="col-sm-3 text-center">
                            <table class="table " style="border : 1px solid gray; text-align: left">
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-auto">
                                            <input type="number" min="0" max="100" class="form-control " id="mark_up_percent" value="<?=$product['mark_up_percent']?>" title="Choose your color">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-auto">
                                            <input type="number" min="0" max="100" class="form-control " id="selling_unit_price_without_vat" value="<?=$product['acquisition_unit_price']*$product['mark_up_percent']/100.0?>" title="Choose your color" readonly>
                                        </div>
                                    </td>
                                </tr>
                            </table>
