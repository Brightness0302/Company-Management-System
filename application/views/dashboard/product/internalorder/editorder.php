                        ...
                        <div class="col-sm-4 text-center">
                          <table class="table mb-0" style="border : 1px solid gray; text-align: left">
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-auto">
                                            <input type="date" class="form-control " id="order_date" value="<?=$order['order_date']?>" title="Choose your color">
                                        </div>
                                    </td>
                                </tr>
                          </table>
                        ...
                        <div class="col-sm-4 text-center">
                          <table class="table mb-0" style="border : 1px solid gray; text-align: left">
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-auto">
                                            <input type="text" class="form-control " id="order_observation" value="<?=$order['order_observation']?>" title="Choose your color">
                                        </div>
                                    </td>
                                </tr>
                          </table>
                                        ...
                                        <td>
                                            <div class="m-auto">
                                                ...
                                                <?php foreach ($products as $index => $product):?>
                                                    <option value="<?=$product['id']?>" <?=$product['id']==$order['product_description']?"selected":""?>>
                                                        <?=$product['name']?>
                                                    </option>
                                                <?php endforeach;?>
                                                </select>
                            ...
                            <div class="col-sm-3 text-center">
                                <table class="table mb-0" style="border : 1px solid gray; text-align: left">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="m-auto">
                                                <input type="number" class="form-control" id="product_qty" value="<?=$order['product_qty']?>" title="Choose your color">
                                            </div>
                                        </td>
                                    </tr>
                                </table>
