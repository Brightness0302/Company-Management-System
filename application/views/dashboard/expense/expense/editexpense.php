            ...
            <div class="pages">
                <div class="page">
                    <div class="input">
                        ...
                        <input id="ExpenseCategory" class="text" type="text" placeholder="" value="<?=$expense['name']?>"/>
                    </div>
                    <div class="input">
                        <div class="title"><i class="material-icons">account_box</i> Expense Code</div>
                        <input id="ExpenseCode" class="text" type="text" placeholder="" value="<?=$expense['code']?>"/>
                    </div>
                </div>
            </div>
            <div class="text-center">
                <button class="cbutton bg-red" onclick="EditExpense('<?=$expense['id']?>')">Save</button> / <a
