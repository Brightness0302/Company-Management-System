                            ...
                            <div class="col-sm-4 text-center d-flex">
                                <table class="table " style="border : 1px solid gray; text-align: left">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control" id="vat_percent" value="0" title="Choose your color">
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-sm-4 text-center d-flex">
                                <table class="table " style="border : 1px solid gray; text-align: left">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="m-auto">
                                                <input type="text" class="form-control " id="vat_amount" value="" title="Choose your color" readOnly>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
