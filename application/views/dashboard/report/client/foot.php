    ...
    $("#invoicetable").DataTable({
        ...
        "buttons": ["copy", "csv", "excel", {
            ...
            customize: function (doc) {
                ...
                doc.content[1].table.widths = ['5%', '10%', '10%', '12%', '12%', '12%', '12%', '12%', '12%'];
            },
                    ...
                    config.exportOptions = {
                        format: {
                            header: function ( data, columnIdx ) {
                                if (data === "Actions" || data === "Action" || data === "Pay" || data === "Invoice status")
                                    return "";
                                return data;
                            }
                        }
    ...
    $.fn.dataTable.ext.search.push(
        function( settings, data, dataIndex ) {
            ...
            if ( settings.nTable.id === 'invoicetable' ) {
                ...
                if (
                    (date > startdate && date < enddate) && (condition1 || condition2 || condition3)
                ) {
                    return true;
                }
                return false;
