    ...
    <section id="hero" class="align-items-center" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="col-sm-3 text-center">
                            <table class="table mb-0" style="border : 1px solid gray; text-align: left">
                              <tr>
                                  ...
                                  <td><input type="text" class="form-control" id="project_name" value="<?=$project['name']?>">
                              </tr>
                            </table>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-3 text-center">
                            <table class="table mb-0" style="border : 1px solid gray; text-align: left">
                              <tr>
                                  ...
                                  <td><input type="text" class="form-control" id="client_name" value="<?=$project['client']['name']?>" data-toggle="modal" data-target="#exampleModalCenter"><label id="client_id" hidden=""><?=$project['client']['id']?></label></td>
                              </tr>
                            </table>
                        </div>
                        <div class="col-sm-3 text-center">
        ...
        <div class="position-relative m-5">
            <div class="text-center">
                <button class="cbutton bg-red" onclick="EditProject('<?=$project['id']?>')">Save</button> / <a href="<?=base_url('project/index')?>"><button class="cbutton bg-white">Cancel</button></a>
            </div>
        </div>
