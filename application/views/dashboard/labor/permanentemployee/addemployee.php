        ...
        <div class="position-relative m-5">
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-9 text-center">
                    <h2>Add New Permanent Employee</h2>
                </div>
            </div>
                        ...
                        <div class="col-sm-4 text-center">
                          <table class="table mb-0" style="border : 1px solid gray; text-align: left">
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-auto">
                                            <input type="text" class="form-control " id="salary" value="0" title="Choose your color">
                                        </div>
                                    </td>
                        ...
                        <div class="col-sm-4 text-center">
                          <table class="table mb-0" style="border : 1px solid gray; text-align: left">
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-auto">
                                            <input type="text" class="form-control " id="tax" value="0" title="Choose your color">
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <label class="my-2"><span class="coin">€</span><span>/monthly</span></label>
                        ...
                        <div class="col-sm-6 text-center">
                          <table class="table mb-0" style="border : 1px solid gray; text-align: left">
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-auto">
                                            <input type="text" class="form-control " id="total" value="0.0" title="Choose your color" disabled>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <label class="my-2"><span class="coin">€</span><span>/monthly</span></label>
                        ...
                        <div class="col-sm-6 text-center">
                          <table class="table mb-0" style="border : 1px solid gray; text-align: left">
                                <tr>
                                    ...
                                    <td>
                                        <div class="m-auto">
                                            <input type="text" class="form-control " id="daily" value="0.0" title="Choose your color" disabled>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <label class="my-2"><span class="coin">€</span><span>/monthly</span></label>
