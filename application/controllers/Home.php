...
/*
    ...
    public function savecompany() {
        ...
        if (!isset($_GET['id'])) {
            $projects_id = $this->home->createItem($name, $number, $address, $VAT, $bankname1, $bic1, $observation1, $bankaccount1, $bankname2, $bic2, $observation2, $bankaccount2, $EORI, $Coin);
            if ($projects_id != -1) {
        ...
        $id = $_GET['id'];
        $result = $this->home->saveItem($id, $name, $number, $address, $VAT, $bankname1, $bic1, $observation1, $bankaccount1, $bankname2, $bic2, $observation2, $bankaccount2, $EORI, $Coin);
        echo $result;
    }
